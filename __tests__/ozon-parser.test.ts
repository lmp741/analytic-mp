...
describe('ozon parser', () => {
  test('parses composite headers and returns rows', async () => {
    const data = [
      ...
      ['Товары', 'Продажи', null, 'Воронка продаж', null],
      ['Артикул', 'Заказано на сумму', 'Средняя цена', 'Показы всего', 'Посещения карточки товара'],
      ['Описание', 'Описание', 'Описание', 'Описание', 'Описание'],
      ['Итого и среднее', null, null, null, null],
      ['GFA-5200', '12 345,67 ₽', '123,45 ₽', '1 000', '100'],
    ];
